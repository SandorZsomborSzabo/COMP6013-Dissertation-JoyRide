 ...
 * @return An instance of `GMSNavigationWaypoint,` or nil if the location is not valid.
 */
 ...
 * @param title A string representing the name of the waypoint.
 * @return An instance of `GMSNavigationWaypoint,` or nil if the Place ID string is nil or empty.
 */
 ...
 * @return An instance of `GMSNavigationWaypoint,` or nil if the location or the
